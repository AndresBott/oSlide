			...
			if(this.isInImageTransition != true){
				...
				div.animate({   opacity:0},100).queue(
					function() {
						...
						//alert(dump(sizes.nofill));
						$this.oSlideImageContainer.width(sizes.nofill.w).height(sizes.nofill.h).css({"position":"relative","top":sizes.nofill.top+"px"});
